...
<a
    href={step.href}
    target="_blank"
    class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-pink-700 text-center cursor-pointer group hover:border-pink-400 duration-200"
>
    <div
